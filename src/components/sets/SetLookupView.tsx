...
type SetsTab = "catalog" | "community";

export function SetLookupView() {
  const [tab, setTab] = useState<SetsTab>("catalog");
        ...
        <div>
          <p className="text-sm text-slate-400">
            {tab === "catalog"
              ...
              : "Discover public chase sets other collectors have published on Slab."}
          </p>
        </div>
